...
export const ALL_ACHIEVEMENTS = {
  ...
  // ===== 新增普通成就（元游戏/里程碑/探索类） =====
  first_steps       : { name: '迈出第一步', icon: '◇', desc: '开启人生模拟，踏上罗的十字路口。' },
  stage_2           : { name: '初露锋芒', icon: '✦', desc: '进入第二阶段，在新东方站稳脚跟。' },
  stage_3           : { name: '锋芒毕露', icon: '⚡', desc: '进入第三阶段，成为公众人物。' },
  stage_4           : { name: '至暗潜行', icon: '▣', desc: '进入第四阶段，在至暗时刻中负重前行。' },
  stage_5           : { name: '真还传·始', icon: '~', desc: '进入第五阶段，开启直播还债之路。' },
  stage_6           : { name: '再上路口', icon: '▤', desc: '进入第六阶段，站上新的十字路口。' },
